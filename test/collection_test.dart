...
void main() {
  ...
  group('trie', () {
    void allTrieTests(
        TrieNode<K, P, V> Function<K, P extends Comparable<P>, V>()
            createRoot) {
      Trie<String, String, num> newTrie() =>
          Trie(parts: (key) => key.toList(), root: createRoot());
      group('add', () {
        test('single', () {
          final trie = newTrie();
          trie['disobey'] = 42;
        ...
        test('multiple', () {
          ...
          expect(
              trie.keysWithPrefix('diso'), ['disobey', 'disorder', 'disown']);
