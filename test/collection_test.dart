...
void main() {
  ...
  group('trie', () {
    Trie<String, String, num> newTrie() => Trie(parts: (key) => key.toList());
    group('add', () {
      test('single', () {
        final trie = newTrie();
        trie['disobey'] = 42;
    ...
    group('constructor', () {
      test('fromTrie', () {
        ...
        firstTrie['abc'] = 42;
        final secondTrie = Trie.fromTrie(firstTrie);
      ...
      test('fromIterable', () {
        final trie = Trie<String, String, int>.fromIterable(['abc', 'abcdef'],
            parts: (key) => key.toList(), value: (value) => value.length);
        expect(trie, hasLength(2));
        expect(trie.keys, ['abc', 'abcdef']);
