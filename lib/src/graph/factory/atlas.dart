...
extension AtlasGraphFactoryExtension<V, E> on GraphFactory<V, E> {
  ...
  /// [vertexCount] (from `0` to `7`) and [edgeCount] (from `0` to `21`), see
  /// [atlas] for details.
...
// Data from "An Atlas of Graphs" by Ronald C. Read and Robin J. Wilson,
// Oxford University Press, 1998.
//
// The data was converted from the IGraph package (https://igraph.org/), which
// in turn converted it from the NetworkX package (https://networkx.github.io/).
const _atlas = [
  [0, 0],
  [1, 0],
  [2, 0],
