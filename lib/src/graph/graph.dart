...
/// Unmodifyable abstract base class of all graphs.
abstract class Graph<V, E> with ToStringPrinter {
  /// Creates a mutable graph builder.
  ///
  /// * [isDirected] specifies if the graph is directed.
  /// * [parallelEdges] specifies if the graph allows parallel edges.
  /// * [uniqueEdges] specifies if the graph enforces unique edges.
  /// * [vertexStrategy] specifies the storage strategy for vertices.
  /// * [edgeStrategy] specifies the storage strategy for edges (if applicable).
  ...
  /// Returns a strategy to store edges.
  StorageStrategy<E> get edgeStrategy;
